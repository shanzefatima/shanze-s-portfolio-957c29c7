              ...
              {messages.map((msg, index) => (
                ...
                >
                  ...
                  <div className={msg.role === "assistant" 
                    ? "bg-muted px-4 py-3 rounded-2xl rounded-tl-sm max-w-[280px]"
                    : "bg-primary px-4 py-3 rounded-2xl rounded-tr-sm max-w-[280px]"
                  }>
            ...
            <div className="p-4 border-t border-border">
              <div className="relative">
                <input
                  ...
                  disabled={isLoading}
                  className="w-full px-4 py-3 bg-muted border border-border rounded-full text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary pr-12 transition-colors disabled:opacity-50"
                />
                <motion.button
