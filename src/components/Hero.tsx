      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="space-y-8 text-lg md:text-xl leading-relaxed text-muted-foreground max-w-4xl pt-8">
            ...
            <p>
              What drives me? Building things that bridge the gap between business goals and human needs. Not just making interfaces pretty, making them profitable and accessible. Not just following best practices, questioning them when they don't serve users. That's the work I care about.
            </p>
          </div>
        </motion.div>
      </div>
