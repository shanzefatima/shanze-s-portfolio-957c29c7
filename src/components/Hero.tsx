...
export const Hero = () => {
  return (
    <section className="relative px-6 py-24 md:py-40 lg:py-48">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="space-y-6">
            ...
            <h1 className="font-sans text-[clamp(2.8rem,8vw,6rem)] leading-[1.05] tracking-tight font-light text-foreground">
              Shanze Fatima Javed
            </h1>
          </div>
          ...
          >
            <p className="text-xl md:text-2xl leading-relaxed text-muted-foreground font-light">
              I turn complex problems into simple, measurable outcomes. 
              Currently focused on accessible product experiences that scale.
            </p>
          </motion.div>
